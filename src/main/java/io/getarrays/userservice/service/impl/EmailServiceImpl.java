...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendMimeMessageWithAttachments(String name, String to, String token) {
        try {
            ...
            FileSystemResource fort = new FileSystemResource(
                    new File(System.getProperty("user.home") + "/Downloads/images/fort.jpg"));
            FileSystemResource dog = new FileSystemResource(
                    new File(System.getProperty("user.home") + "/Downloads/images/dog.jpg"));
            FileSystemResource homework = new FileSystemResource(
                    new File(System.getProperty("user.home") + "/Downloads/images/homework.docx"));
    ...
    public void sendHtmlEmail(String name, String to, String token) {
        try {
            ...
            /*
             * FileSystemResource fort = new FileSystemResource(new
             * File(System.getProperty("user.home") + "/Downloads/images/fort.jpg"));
             * FileSystemResource dog = new FileSystemResource(new
             * File(System.getProperty("user.home") + "/Downloads/images/dog.jpg"));
             * FileSystemResource homework = new FileSystemResource(new
             * File(System.getProperty("user.home") + "/Downloads/images/homework.docx"));
             * helper.addAttachment(fort.getFilename(), fort);
             * helper.addAttachment(dog.getFilename(), dog);
             * helper.addAttachment(homework.getFilename(), homework);
             */
