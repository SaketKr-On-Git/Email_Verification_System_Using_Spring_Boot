...
public class UserServiceImpl implements UserService {
    ...
    public User saveUser(User user) {
        ...
        // emailService.sendMimeMessageWithAttachments(user.getName(), user.getEmail(),
        // confirmation.getToken());
        // emailService.sendMimeMessageWithEmbeddedFiles(user.getName(),
        // user.getEmail(), confirmation.getToken());
        // emailService.sendHtmlEmail(user.getName(), user.getEmail(),
        // confirmation.getToken());
